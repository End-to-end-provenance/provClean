...
capture.output(lm.summary.1, file="projects/lm_table_1.txt")
write.csv(out.summary, file="projects/table_2.csv")
...
png('projects/fig1_biplot.png')
plot(data.16[,1:2])
dev.off()

png('projects/fig1_biplot_t2.png')
plot(data.16[,1:2]*2)
dev.off()

png('projects/fig2_biplot.png')
plot(data.16[,2:3])
dev.off()
